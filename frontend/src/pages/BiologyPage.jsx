...
const BiologyPage = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8 font-sans">
      <div className="h-16 w-16 bg-accent/10 border border-accent/20 rounded-2xl flex items-center justify-center text-accent mb-6 animate-pulse">
        <Dna size={32} />
      </div>
      <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">Biology 3D Model Viewer</h2>
      <p className="text-sm text-slate-500 dark:text-slate-400 max-w-sm leading-relaxed mb-6">
        The biological cellular structures (mitosis, DNA helix) are currently being processed into low-poly GLTF components.
      </p>
