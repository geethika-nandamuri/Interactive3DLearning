...
const EngineeringPage = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8 font-sans">
      <div className="h-16 w-16 bg-primary/10 border border-primary/20 rounded-2xl flex items-center justify-center text-primary mb-6 animate-pulse">
        <Wrench size={32} />
      </div>
      <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">Engineering 3D Model Viewer</h2>
      <p className="text-sm text-slate-500 dark:text-slate-400 max-w-sm leading-relaxed mb-6">
        Mechanical assemblies, gearboxes, and engine models are being optimized for exploded view integration.
      </p>
